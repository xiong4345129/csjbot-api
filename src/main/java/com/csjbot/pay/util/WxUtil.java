...
import com.csjbot.pay.controller.WxOrderRequestBuilder;
...
public final class WxUtil {
    ...
    public static String computeSign(Map<String, String> map, String key, boolean verbose)
        ...
        signSrc = signSrc + "&" + WxOrderRequestBuilder.K_API_KEY + "=" + key;
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        map.put("notify_url", "http://120.27.233.57:9090/api/pay/wx/callback");
        ...
        String sign = computeSign(map, WxOrderRequestBuilder.SANDBOX_API_KEY, true);
